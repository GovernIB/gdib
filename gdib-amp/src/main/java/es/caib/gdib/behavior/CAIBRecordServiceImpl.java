 ...
 */
@BehaviourBean
public class CAIBRecordServiceImpl extends BaseBehaviourBean
                                          ...
                                          NodeServicePolicies.BeforeDeleteNodePolicy
{
    ...
    // ADD Incluidas las uris de los metadatos de eni y gdib para que permita modificarlos en el RM
    ...
    private static final String[] ALWAYS_EDIT_URIS = new String[]
    {
        ...
        ConstantUtils.NS_ENI,
        ConstantUtils.NS_CAIB
     };
    ...
    public void onCreateChildAssociation(final ChildAssociationRef childAssocRef, final boolean bNew)
    {
        AuthenticationUtil.runAs(new RunAsWork<Void>()
        {
            ...
            public Void doWork()
            {
                ...
                {
                	LOGGER.debug("onCreateCHild finally");
                    onCreateChildAssociation.enable();
                }
                LOGGER.debug("onCreateCHild return");
                return null;
            }
    ...
    public void makeRecord(NodeRef document)
    {
        ...
        {
        	LOGGER.debug("catching exception makeRecord");
        	LOGGER.debug(e.getMessage());
