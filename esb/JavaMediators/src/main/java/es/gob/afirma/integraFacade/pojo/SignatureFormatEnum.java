...
public enum SignatureFormatEnum {
	 ...
	 */
	CMS(SignTypesURIs.CMS, null), CAdES(SignTypesURIs.CADES, null), CAdES_BES(SignTypesURIs.CADES, SignatureForm.BES), CAdES_EPES(SignTypesURIs.CADES, SignatureForm.EPES), CAdES_T(SignTypesURIs.CADES, SignatureForm.T), CAdES_X(SignTypesURIs.CADES, SignatureForm.X), CAdES_X1(SignTypesURIs.CADES, SignatureForm.X_1), CAdES_X2(SignTypesURIs.CADES, SignatureForm.X_2), CAdes_XL(SignTypesURIs.CADES, SignatureForm.X_L), CAdES_XL1(SignTypesURIs.CADES, SignatureForm.X_L_1), CAdES_XL2(SignTypesURIs.CADES, SignatureForm.X_L_2), CAdES_A(SignTypesURIs.CADES, SignatureForm.A), XAdES(SignTypesURIs.XADES_V_1_3_2, null), XAdES_BES(SignTypesURIs.XADES_V_1_3_2, SignatureForm.BES), XAdES_EPES(SignTypesURIs.XADES_V_1_3_2, SignatureForm.EPES), XAdES_T(SignTypesURIs.XADES_V_1_3_2, SignatureForm.T), XAdES_X(SignTypesURIs.XADES_V_1_3_2, SignatureForm.X), XAdES_X1(SignTypesURIs.XADES_V_1_3_2, SignatureForm.X_1), XAdES_X2(SignTypesURIs.XADES_V_1_3_2, SignatureForm.X_2), XAdES_XL(SignTypesURIs.XADES_V_1_3_2, SignatureForm.X_L), XAdES_XL1(SignTypesURIs.XADES_V_1_3_2, SignatureForm.X_L_1), XAdES_XL2(SignTypesURIs.XADES_V_1_3_2, SignatureForm.X_L_2), XAdES_A(SignTypesURIs.XADES_V_1_3_2, SignatureForm.A), ODF(SignTypesURIs.ODF, null), PDF(SignTypesURIs.PDF, null), PAdES(SignTypesURIs.PADES, SignatureForm.PADES_BASIC), PAdES_BES(SignTypesURIs.PADES, SignatureForm.PADES_BES), PAdES_EPES(SignTypesURIs.PADES, SignatureForm.PADES_EPES), PAdES_LTV(SignTypesURIs.PADES, SignatureForm.PADES_LTV);
