...
import es.caib.archivodigital.esb.services.mediators.afirma.integraFacade.pojo.CaibEsbBatchVerifySignatureResponse;
...
public class AsynchronousResponse implements Serializable {
	 ...
	 */
	private CaibEsbBatchVerifySignatureResponse batVerSigRes;
	 ...
	 */
	public final CaibEsbBatchVerifySignatureResponse getBatVerSigRes() {
		return batVerSigRes;
	}
	 ...
	 */
	public final void setBatVerSigRes(CaibEsbBatchVerifySignatureResponse batVerSigResParam) {
