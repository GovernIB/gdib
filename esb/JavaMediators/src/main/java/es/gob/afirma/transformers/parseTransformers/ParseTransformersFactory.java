...
public final class ParseTransformersFactory {
	...
	public static Class<Object> getParseTransformer(String serviceReq, String method, String version) throws TransformersException {
		...
		try {
			if (!GenericUtils.assertStringValue(serviceReq) || !GenericUtils.assertStringValue(method)) {
				throw new TransformersException(CaibEsbLanguage.getFormatResIntegra(ILogConstantKeys.PTF_LOG001, new Object[ ] { serviceReq, version }));
			}
			transformerClass = getTransformerClassName(serviceReq, method, version);
			if (transformerClass == null) {
				throw new TransformersException(CaibEsbLanguage.getFormatResIntegra(ILogConstantKeys.PTF_LOG002, new Object[ ] { serviceReq, method, version }));
			}
			...
			if (!found) {
				res = null;
				throw new TransformersException(CaibEsbLanguage.getFormatResIntegra(ILogConstantKeys.PTF_LOG003, new Object[ ] { transformerClass, IParseTransformer.class.getName() }));
			}
			logger.debug(CaibEsbLanguage.getFormatResIntegra(ILogConstantKeys.PTF_LOG004, new Object[ ] { transformerClass }));
	...
	private static String getTransformerClassName(String serviceReq, String method, String version) {
		...
		properties = CaibEsbTransformersProperties.getMethodParseTransformersProperties(serviceReq, method, version);
