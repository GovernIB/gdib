...
public interface Signer {
	 ...
	 * The allowed values for CAdES signature are:
	 * <ul>
	 * <li>{@link es.gob.afirma.signature.SignatureFormatDetector#FORMAT_CADES_BES}</li>
	 * <li>{@link es.gob.afirma.signature.SignatureFormatDetector#FORMAT_CADES_EPES}</li>
	 * </ul>
	 * The allowed values for XAdES signature are:
	 * <ul>
	 * <li>{@link es.gob.afirma.signature.SignatureFormatDetector#FORMAT_XADES_BES}</li>
	 * <li>{@link es.gob.afirma.signature.SignatureFormatDetector#FORMAT_XADES_EPES}</li>
	 * </ul>
	 * The allowed values for PAdES signature are:
	 * <ul>
	...
	/**
	 * Method that generates a basic co-signature (signature with signers on parallel). This functionality is unsupported for PAdES signatures.
	...
	/**
	 * Method that generates a basic counter-signature (signature with signers on serial). This functionality is unsupported for PAdES signatures.
	 * @param signature Parameter that represents the original signature.
	 * @param algorithm Parameter that represents the signature algorithm.
	 * @param privateKey Parameter that represents the private key of the signing certificate.
	 * @param extraParams Set of extra configuration parameters.
