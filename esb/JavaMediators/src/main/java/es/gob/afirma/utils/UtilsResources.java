	...
	public static void safeCloseInputStream(InputStream is) {
		if (is != null) {
			try {
				...
				LOGGER.error(CaibEsbLanguage.getFormatResIntegra(ILogConstantKeys.UR_LOG001, new Object[ ] { is.getClass().getName() }), e);
			}
		}
	}
	...
	public static void safeCloseOutputStream(OutputStream os) {
		if (os != null) {
			try {
				...
				LOGGER.error(CaibEsbLanguage.getFormatResIntegra(ILogConstantKeys.UR_LOG001, new Object[ ] { os.getClass().getName() }), e);
			}
		}
	}
	...
	public static void safeCloseSocket(Socket socket) {
		if (socket != null) {
			try {
				...
				LOGGER.error(CaibEsbLanguage.getFormatResIntegra(ILogConstantKeys.UR_LOG001, new Object[ ] { socket.getClass().getName() }), e);
			}
		}
	}
