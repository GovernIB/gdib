...
/**
 * Clase que define constantes para rutas Xpath de las respuestas retornadas por los servicios web DSS de la plataforma @firma v6.
 */
public final class CaibEsbDSSTagsResponse {

	/**
	 * Constructor method for the class DSSTagsResponse.java.
	 */
	private CaibEsbDSSTagsResponse() {
	}
	 ...
	 */
	public static final String SIGNATURE = SIGNATURE_OBJECT + "/dss:Signature";
	...
	/**
	 * Constant attribute that represents the XPath for the tag <code>/vr:IndividualSignatureReport/vr:Details/vr:DetailedReport/vr:Properties/vr:UnsignedProperties/vr:UnsignedSignatureProperties/vr:SignatureTimeStamp/vr:TimeStampContent/vr:CreationTime</code>.
	 */
	public static final String IND_SIG_TIMESTAMP_CREATION_TIME = INDIVIDUAL_SIGNATURE_REPORT + "/vr:Details/vr:DetailedReport/vr:Properties/vr:UnsignedProperties/vr:UnsignedSignatureProperties/vr:SignatureTimeStamp/vr:TimeStampContent/vr:CreationTime";
