 ...
 */
package es.caib.archivodigital.esb.services.mediators.afirma.i18n;
 ...
 * @version 1.0, 24/01/2014.
 */
public final class CaibEsbLanguage {
	 ...
	 */
	private static final Logger LOGGER = Logger.getLogger(CaibEsbLanguage.class);

	/**
	 * Constructor method for the class Language.java.
	 */
	private CaibEsbLanguage() {
	}
	...
	public static void reloadMessagesConfiguration() {		
		...
		InputStream languageIs = CaibEsbLanguage.class.getResourceAsStream("/" + BUNDLENAME_LANGUAGE + ".properties");
		if (languageIs == null) {
